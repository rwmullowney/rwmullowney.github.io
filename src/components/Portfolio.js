      ...
      <div className="container text-center mt-4">
        <div className="row">
          <div className="col-6 justify-content-center">
            ...
            <p className="mt-5 mx-5 font-weight-light">A web app designed to foster political engagement by allowing users to search via zip
code to view their representatives, and their contact information</p>
          ...
          <div className="col-6">
            ...
            <p className="mt-5 mx-5 font-weight-light">A cryptocurrency market simulator that allows you to invest virtual money based on real-time coin values</p>
          </div>
        </div>
      </div>
